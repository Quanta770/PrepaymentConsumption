...
@EndUserText.label: 'Get the latest Collection Invoice number'
@Metadata.ignorePropagatedAnnotations: true
define view entity ZI_GET_COLLECTION_INV_NUM
    as select from    ZI_COLLECTIONINV_LATEST as Opp   //ZI_OPPACCITEM_REF3
