...
@EndUserText.label: 'Intermediate View'
...
define view entity ZI_PREPAYMENT_DELIVERY_SO_INT as select from ZI_PREMAYMENT_SO_HDR_ITEM_FLTR as Prev
  left outer join ZI_DELIVERY_SO_HDR_ITEM_FLTR as delv
...
left outer join ZI_PREMAYMENT_SO_HDR_ITEM_FLTR as Prev
